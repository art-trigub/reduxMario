...
function EditFamilyPerson({ data, saveChangedPersonData, list, getListHealthInsurance }) {
                        ...
                        <Grid container spacing={2} alignItems='center'>
                            <Grid className="fixed-height__input" item xs={6}>
                                <FormControl className={classes.formControl}>
                                    ...
                                    <Select name='status' value={editedData.status} onChange={onChange}>
...
function mapStateToProps({ clientFamily, healthInsurance }) {
    return {
        editedPerson: clientFamily.editedPerson,
