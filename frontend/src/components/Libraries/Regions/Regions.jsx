...
import { deleteItem } from '../../../store/actions/libraries/regions'
import { getData, onSave, editItem } from '../../../store/actions/libraries/regions'
import { changeListBreadCrumbs } from '../../../store/actions/breadCrumbs'
import '../style.css'


function Regions({ getData, list, isLoading, deleteItem, onSave, editItem }) {
    ...
    useEffect(() => {
        document.title = t('regions')
        dispatch(changeListBreadCrumbs([`${t('libraries')}`, `${t('regions')}`]))
    }, [t])
                            ...
                            <Table stickyHeader aria-label="sticky table" size="small" className={classes.table}>
                                <TableHead>
                                    <TableRow>
                                        ...
                                        <IHeaderTableCell align="center">{t("regions")}</IHeaderTableCell>
                                    </TableRow>
                                </TableHead>
                                <TableBody>
                                    {(rowsPerPage > 0
