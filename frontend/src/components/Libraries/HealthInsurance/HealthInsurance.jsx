...
import { deleteItem } from '../../../store/actions/libraries/healthInsurance'
import { getData, onSave, editItem } from '../../../store/actions/libraries/healthInsurance'
import { changeListBreadCrumbs } from '../../../store/actions/breadCrumbs'


function HealthInsurance({ getData, list, isLoading, deleteItem, onSave, editItem }) {
    ...
    useEffect(() => {
        document.title = t('hospitalCassa')
        dispatch(changeListBreadCrumbs([`${t('libraries')}`, `${t('hospitalCassa')}`]))
    }, [t])
...
function mapStateToProps({ healthInsurance }) {
    return {
        ...
        isLoading: healthInsurance.isLoading
    }
}
