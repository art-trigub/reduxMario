    ...
    'managers'                   => [
        'default' => [
            ...
            */
            ...
            'filters'       => [
                'lastName' => "\App\Repositories\User\Criterion\LastNameCriterion",
                'userId' => "\App\Repositories\User\Criterion\GetIdCriterion",
                'firstName' => "\App\Repositories\User\Criterion\FirstNameCriterion",
                'email' => "\App\Repositories\User\Criterion\EmailCriterion",
                'dateOfBirth' => "\App\Repositories\User\Criterion\DateOfBirthCriterion",
                'internalPhone' => "\App\Repositories\User\Criterion\InternalPhoneCriterion",
                'role' => "\App\Repositories\User\Criterion\RoleCriterion",
                'department' => "\App\Repositories\User\Criterion\DepartmentCriterion",
            ],
            /*
            |--------------------------------------------------------------------------
